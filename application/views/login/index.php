    ...
    <body>
        ...
        <div id="login-container">
            ...
            <h1 class="h2 text-light text-center push-top-bottom animation-slideDown">
                <i class="fa fa-cube"></i> <br> <strong>Login Admin SIDUMAS</strong>
            </h1>
            <!-- END Login Header -->
            ...
            <div class="block animation-fadeInQuickInv">
                ...
                ?>
                <!-- Login Form -->
                <form id="form-login" action="<?php echo site_url('login/proses') ?>" method="post" class="form-horizontal">
            ...
            <footer class="text-muted text-center animation-pullUp">
                <small><span>2020</span> &copy; <a href="" target="_blank">Agung</a></small>
            </footer>
            <!-- END Footer -->
        </div>
        <!-- END Login Container -->
