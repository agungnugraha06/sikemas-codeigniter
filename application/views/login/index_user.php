    ...
    <body>
        ...
        <div id="login-container">
            ...
            <h1 class="h2 text-light text-center push-top-bottom animation-slideDown">
                <i class="fa fa-cube"></i> <br> <strong>Selamat Datang di Sistem Informasi Keluhan Masyarakat</strong>
            </h1>
            <!-- END Login Header -->
            ...
            <div class="block animation-fadeInQuickInv">
                ...
                <form id="form-login" action="<?php echo site_url('login/proses_user') ?>" method="post" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input type="password" name="password" class="form-control" placeholder="Masukkan Password.." autofocus>
                        </div>
                    </div>
            ...
            <footer class="text-muted text-center animation-pullUp">
                <small>
                    ...
                    <span>2020</span> &copy; <a href="" target="_blank">Agung Nugraha</a>
                </small>
            </footer>
            <!-- END Footer -->
        </div>
