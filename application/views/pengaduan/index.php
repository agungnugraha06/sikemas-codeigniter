                ...
                <table id="example-datatable" class="table table-striped table-bordered table-vcenter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            ?>
                            <td class="text-center">
                                <a href="<?php echo site_url('Pengaduan/detail/'.$row->id_pengaduan) ?>" data-toggle="tooltip" title="Detail Keluhan" class="btn btn-effect-ripple btn-s btn-warning"><i class="fa fa-eye"></i></a>
                            ...
                            <td class="text-center">
                                <a href="<?php echo site_url('Pengaduan/detail/'.$row->id_pengaduan) ?>" data-toggle="tooltip" title="Detail Keluhan" class="btn btn-effect-ripple btn-s btn-warning"><i class="fa fa-eye"></i></a>
                                <a href="<?php echo site_url('Pengaduan/edit/'.$row->id_pengaduan) ?>" data-toggle="tooltip" title="Edit Keluhan" class="btn btn-effect-ripple btn-s btn-success"><i class="fa fa-pencil"></i></a>
                                <a href="<?php echo site_url('Pengaduan/hapus/'.$row->id_pengaduan) ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus?')" data-toggle="tooltip" title="Delete Keluhan" class="btn btn-effect-ripple btn-s btn-danger"><i class="fa fa-times"></i></a>
                            </td>
                            <?php } ?>
                        </tr>
                        <?php $no++; } ?>
